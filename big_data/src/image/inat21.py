...
# Map evaldataset → inat21 supercategory name
inat21_SUPERCATEGORIES = {
    'inat21-amphibians': 'Amphibians',
    'inat21-animalia': 'Animalia',
    'inat21-arachnids': 'Arachnids',
    'inat21-birds': 'Birds',
    'inat21-fungi': 'Fungi',
    'inat21-insects': 'Insects',
    'inat21-mammals': 'Mammals',
    'inat21-mollusks': 'Mollusks',
    'inat21-plants': 'Plants',
    'inat21-rayfish': 'Ray-finned Fishes',
    'inat21-reptiles': 'Reptiles',
}
...
class inat21Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if file_name.startswith("val/"):
            img_path = os.path.join(self.root, file_name[len("val/"):])
        else:
...
def get_dataloaders(args, eval_transform=None):
    ...
    supercategory = inat21_SUPERCATEGORIES.get(evaldataset, None)

    dataset = inat21Dataset(
